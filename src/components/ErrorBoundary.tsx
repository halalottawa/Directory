    ...
    if (this.state.hasError) {
      ...
      return (
        <div className="min-h-[400px] flex flex-col items-center justify-center p-6 text-center space-y-4">
          <div className="w-16 h-16 bg-red-50 rounded-full flex items-center justify-center text-[#e90b35]">
          ...
          <button
            ...
            className="px-6 py-2 bg-[#e90b35] text-white font-bold rounded-xl active:scale-95 transition-all"
          >
            Try Again
          </button>
        </div>
